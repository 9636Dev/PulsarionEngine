...
if [ $COMPILE_COMMANDS ]; then
    ...
    cmake -G "$GENERATOR" -DPULSARION_LIBRARY_TYPE="$LIBRARY_TYPE" -DCMAKE_BUILD_TYPE="$BUILD_TYPE" "$BUILD_DIR" -DPULSARION_SIMD="$SIMD" -DCMAKE_EXPORT_COMPILE_COMMANDS=ON
else
    cmake -G "$GENERATOR" -DPULSARION_LIBRARY_TYPE="$LIBRARY_TYPE" -DCMAKE_BUILD_TYPE="$BUILD_TYPE" "$BUILD_DIR" -DPULSARION_SIMD="$SIMD"
fi
